...
import dataa.eleger.jwt.services.lmpl.DetalheUsuarioServiceImpl;
...
public class JWTConfiguracao extends WebSecurityConfigurerAdapter {
    ...
    protected void configure(HttpSecurity http) throws Exception {
        // csrf desabilitado não previne ataques.
        http.csrf().disable().authorizeRequests()
                .antMatchers(HttpMethod.POST, "/login", "/swagger-ui/**", "/swagger-resources/**", "/webjars/**").permitAll()
                .and()
